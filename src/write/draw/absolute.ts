const drawTempo = require('./tempo');
const drawRelativeElement = require('./relative');
const spacing = require('../helpers/spacing');
const setClass = require('../helpers/set-class').default;
const elementGroup = require('./group-elements');
...
function drawAbsolute(renderer, params, bartop, selectables, staffPos) {
	...
	const g = elementGroup.endGroup(klass, params.type, params.extraClass);
	if (g) {
