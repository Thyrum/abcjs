const layoutVoiceElements = require('./voice-elements');
...
const layoutStaffGroup = function (spacing, minPadding, debug, staffGroup, leftEdge) {
	...
	let minspace = 1000; // a big number to start off with - used to find out what the smallest space between two notes is -- GD 2014.1.7
